...
\begin{figure}[H]
\centering
\subfigure[Without validation filters: multiple false positives (sofa and chair incorrectly detected as pedestrians)]{\includegraphics[width=0.48\columnwidth]{../report/pruebas/sin-filtros.jpeg}}
\hfill
\subfigure[With 6 validation filters: only 2 real people correctly detected with their COCO keypoints]{\includegraphics[width=0.48\columnwidth]{../report/pruebas/con-filtros.jpeg}}
...
\begin{figure}[H]
\centering
\subfigure[Standing person (17 keypoints, 96\% confidence)]{\includegraphics[width=0.30\columnwidth]{../report/pruebas/01-persona-pie.png}}
\hfill
\subfigure[Person from behind (17 keypoints)]{\includegraphics[width=0.30\columnwidth]{../report/pruebas/02-persona-espaldas.png}}
\hfill
\subfigure[Leaning person (16 keypoints, 88\% confidence)]{\includegraphics[width=0.30\columnwidth]{../report/pruebas/03-persona-inclinada.png}}

\subfigure[Sitting person (15 keypoints, 86\% confidence)]{\includegraphics[width=0.30\columnwidth]{../report/pruebas/04-persona-sentada.png}}
\hfill
\subfigure[Two standing people (34 keypoints, 92\% confidence)]{\includegraphics[width=0.30\columnwidth]{../report/pruebas/05-2-personas-pie.png}}
\hfill
\subfigure[One standing, one sitting (33 keypoints)]{\includegraphics[width=0.30\columnwidth]{../report/pruebas/06-1-pie-1-sentada.png}}
...
\begin{figure}[H]
\centering
\subfigure[Two sitting people (30 keypoints, 89\% confidence)]{\includegraphics[width=0.30\columnwidth]{../report/pruebas/07-2-personas-sentadas.png}}
\hfill
\subfigure[Two standing people - frontal view (34 keypoints)]{\includegraphics[width=0.30\columnwidth]{../report/pruebas/08-2-personas-pie.png}}
\hfill
\subfigure[Two leaning people (32 keypoints, 87\% confidence)]{\includegraphics[width=0.30\columnwidth]{../report/pruebas/09-2-personas-inclinadas.png}}

\subfigure[One crouching and one sitting (31 keypoints, 90\% confidence)]{\includegraphics[width=0.30\columnwidth]{../report/pruebas/10-1-agachada-1-sentada.png}}
\hfill
...
Source code, datasets and trained models are publicly available at \url{https://github.com/FepDev25/Deteccion-de-Peatones.git} to facilitate reproducibility and extension of the work.
